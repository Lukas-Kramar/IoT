...
import { sensorGetConfiguratinValidator, SensorGetConfigurationRequest } from '../validators/measurementPoint/sensor/sensorGet.validator';
...
sensorRouter.post(
    ...
    async (req: SensorAddRequest, res: Response, next: NextFunction) => {
        ...
        const { measurementPointId, sensorId, ...sensorToAdd } = req.body;
